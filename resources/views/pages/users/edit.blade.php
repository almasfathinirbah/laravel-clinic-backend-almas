                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="selectgroup w-100">
                                    ...
                                    <label class="selectgroup-item">
                                        <input type="radio" name="role" value="nurse" class="selectgroup-input"
                                        @if($user->role == 'nurse') checked="" @endif>
                                        <span class="selectgroup-button">Nurse</span>
                                    </label>
                                    <label class="selectgroup-item">
                                        <input type="radio" name="role" value="pharmacist" class="selectgroup-input"
                                        @if($user->role == 'pharmacist') checked="" @endif>
                                        <span class="selectgroup-button">Pharmacist</span>
                                    </label>
                                    <label class="selectgroup-item">
